      ...
      <motion.div style={{ y, opacity }} className="relative z-10 mx-auto max-w-7xl px-6 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <motion.div style={{ y: imgY }} className="relative">
          ...
          >
            ...
            <img
              src={`${import.meta.env.BASE_URL}hero-panther.png`}
              alt="Brand Panther — low-poly violet panther, premium digital marketing visual"
              width={1022}
              height={581}
              loading="eager"
              className="relative z-[2] w-full rounded-[1.35rem] object-cover aspect-[1022/581] brightness-[1.02] contrast-[1.02]"
            />
          </motion.div>
        </motion.div>
      </motion.div>
