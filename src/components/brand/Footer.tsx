    ...
    <footer className="relative border-t border-border/60 pt-16 pb-8 px-6">
      <div className="mx-auto max-w-7xl grid md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li><a href="tel:+919025430301" className="hover:text-primary-glow transition-colors">+91 90254 30301</a></li>
          </ul>
        </div>
      </div>
      ...
      <div className="mt-12 pt-6 border-t border-border/40 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-muted-foreground">
        ...
        <div>
          Developed by{" "}
          <a
            href="https://www.mintxsolutions.com"
            target="_blank"
            rel="noopener noreferrer"
            className="text-primary-glow hover:text-foreground transition-colors underline-offset-2 hover:underline"
          >
            MintX Solutions
          </a>
        </div>
